...
# Zone boundaries (set to fit your scene)
ZONE_LEFT_X = 300
ZONE_RIGHT_X = 450
DUPLICATE_DISTANCE_THRESHOLD = 50
recent_detections = deque(maxlen=15)  # 10-frame memory
...
def process_frame(frame):
    ...
    # Show count
    cv2.putText(frame, f"Helmet count: {helmet_count}", (20, 30),
                cv2.FONT_HERSHEY_SIMPLEX, 0.8, COLORS['helmet'], 2)
    cv2.putText(frame, f"Head count: {head_count}", (20, 60),
